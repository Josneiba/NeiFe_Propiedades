...
export const CHILE_REGIONS_DATA: Record<string, { code: string; communes: string[] }> = {
  ...
  "Región de Los Ríos (XIV)": {
    code: "XIV",
    communes: ["Valdivia", "Corral", "Futrono", "La Unión", "Lago Ranco", "Lanco", "Los Lagos", "Máfil", "Mariquina", "Paillaco", "Panguipulli", "Río Bueno"]
  },
...
export const getRegions = () => Object.keys(CHILE_REGIONS_DATA)

export const getCommunesByRegion = (region: string) => {
  return CHILE_REGIONS_DATA[region]?.communes || []
}
