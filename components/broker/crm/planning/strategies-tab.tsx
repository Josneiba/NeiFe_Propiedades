  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {strategies.length === 0 ? (
          <div className="rounded-lg border border-[#2D3C3C] bg-[#1a2a2a] p-8 text-center text-[#D5C3B6]">
            <p className="text-lg font-semibold text-[#FAF6F2]">No hay estrategias activas esta semana</p>
            <p className="mt-2 text-sm text-[#9C8578]">Define una estrategia con un objetivo claro y luego crea actividades para que el pipeline avance con foco.</p>
            <p className="mt-4 text-xs uppercase tracking-[0.18em] text-[#5E8B8C]">Usa el formulario superior para empezar</p>
          </div>
